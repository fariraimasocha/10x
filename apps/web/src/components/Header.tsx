      ...
      <div className="mx-auto flex max-w-[118rem] items-center justify-between px-5 py-4 lg:px-10">
        ...
        <div className="flex items-center justify-end gap-3 md:w-1/4">
          <a
            ...
            className="flex h-9 w-9 items-center justify-center rounded-[8px] border border-[var(--color-line-strong)] bg-[var(--color-surface)] transition-colors hover:border-[var(--color-ink)]"
          >
